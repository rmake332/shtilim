...
export const DOC_FIELDS = [
  ...
  },
  {
    ...
    label: 'נתוני העסקה',
    condition: 'newEmployeeParaOrTeaching', // שם ישן; ההצגה בפועל נקבעת ב-RoleStep.showMinistryFileQuestion (עובד חדש + קטגוריה פרא/הוראה + סוג שכר "דירוג וותק"), לא לפי condition זה
    menoExcluded: false,
    adultOnly: false,
  },
] as const;
...
export const SCHEDULE_TYPE = {
  ...
  teaching: 'הוראה',
  para: 'פרא',
  /** עוז: זהה ל"הוראה" לכל אורך הזרימה; רק החיפוש במחשבון אופק חדש נעשה בקטגוריה
   * "עוז" ובסדר מפתח אחר (למשל "עוז0לאחטיבה1.5"). */
  oz: 'עוז',
  ...
  /** הוראה ללא אופק חדש: הזנה בלוח צלצולים כמו הוראה, אך אחרי ההזנה אין בדיקה
   * במחשבון אופק חדש: השעות שנבחרו הן השעות הסופיות, בלי פירוט פרונטלי/פרטני/שהייה. */
